...
export const introductionCover: CourseStructure["introduction"]["cover"] = {
  slideId: "intro-cover",
  navbarTitle: "Portada del Curso",
  titleLine1: "Manejo seguro de caballos:",
  titleLine2: "Prácticas Esenciales",
  subtitle:
    "",
  ctaLabel: "COMENZAR",
